...
import { FaFireAlt, FaRegClock, FaLeaf, FaShoppingBasket, FaStar } from 'react-icons/fa'; // FaFireAlt for chili, FaRegClock/FaLeaf for general features
import { IoIosArrowDropleftCircle, IoIosArrowDroprightCircle } from 'react-icons/io';

const ChilliGarlicBitesPage = () => {
  const sectionRefs = useRef([]); // For scroll animations
  const productImages = [
    "https://foodellafoods.com/wp-content/uploads/2023/10/Chilli-Garlic-Bites-1-247x300.png", // Replace with your Chilli Garlic Bites pack image
    "https://foodellafoods.com/wp-content/uploads/2023/10/chhhiii.jpg", // Replace with crispy texture close-up
  ];
  ...
  // Sample data for Nutritional Facts (IMPORTANT: Update with actual data for your Chilli Garlic Bites)
  const nutritionalData = [
    { nutrient: "Energy (kcal)", per100g: "155", rda: "7.8" }, // Adjusted slightly for bites
    { nutrient: "Protein (g)", per100g: "3.0", rda: "-" },
    { nutrient: "Carbohydrate (g)", per100g: "24.0", rda: "-" },
    { nutrient: "Total Sugars (g)", per100g: "<0.5", rda: "-" },
    { nutrient: "Added Sugars (g)", per100g: "0", rda: "0" },
    { nutrient: "Total Fat (g)", per100g: "5.0", rda: "7.5" },
    { nutrient: "  Saturated Fat (g)", per100g: "Not more than 2.0", rda: "10.0" },
    { nutrient: "  Trans Fat (g)", per100g: "Not more than 0.1", rda: "5" },
    { nutrient: "Sodium (mg)", per100g: "80", rda: "4.0" }, // Sodium for spiced bites
  ];
  ...
  return (
    <div className="font-poppins bg-[#FFF8E1] text-gray-800 leading-relaxed overflow-hidden">
        ...
        <div className="container mx-auto md:pb-20 flex flex-col md:flex-row items-center justify-between relative z-10 text-white gap-12">
          ...
          <div className="text-center md:text-left md:w-1/2 animate-slide-in-left">
            <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-4 drop-shadow-lg">
              Foodella <span className="text-red-900">Chilli Garlic</span> Bites
            </h1>
            <p className="text-xl md:text-2xl font-light max-w-lg mb-8 opacity-90">
              Ignite your taste buds with Foodella Chilli Garlic Bites! Crispy, flavorful,
              and packed with a fiery kick of chili and aromatic garlic. The perfect spicy snack!
            </p>
          ...
          <div className="relative w-full md:w-2/5 mx-10 flex justify-center items-center h-96 md:h-[600px] animate-scale-in-delay">
            <img
              ...
              alt="Foodella Chilli Garlic Bites Pack"
      ...
      >
        ...
        <div className="container mx-auto px-8 relative z-10 text-center">
          <h2 className="text-5xl font-extrabold mb-16 drop-shadow-md animate-fade-in-up">
            Why Foodella Chilli Garlic Bites?
          </h2>
          <div className="grid md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              ...
              <h3 className="text-3xl font-bold mb-4">Fiery Chilli Kick</h3>
              <p className="text-lg opacity-90">
                A bold and exciting chili flavor that delivers a satisfying heat with every bite.
              </p>
            </div>
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              <FaRegClock className="text-6xl text-yellow-400 mb-6 transform group-hover:scale-110 transition-transform" />
              <h3 className="text-3xl font-bold mb-4">Aromatic Garlic Infusion</h3>
              <p className="text-lg opacity-90">
                Rich, savory garlic notes perfectly complement the chili, creating a harmonious blend.
              </p>
            </div>
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              <FaLeaf className="text-6xl text-yellow-400 mb-6 transform group-hover:scale-110 transition-transform" />
              <h3 className="text-3xl font-bold mb-4">Irresistible Crispy Texture</h3>
              <p className="text-lg opacity-90">
                Cooks up to a perfect golden crispness, making them an addictive snack.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* INLINED: Nutritional Facts Section for Chilli Garlic Bites */}
      <section
      ...
      >
        <div className="container mx-auto px-8">
          <h2 className="text-5xl font-extrabold text-red-600 mb-16">
            Your Path to Perfect Chilli Garlic Bites
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <img src="https://foodellafoods.com/wp-content/uploads/2023/10/Chilli-Garlic-Bites-1-247x300.png" alt="Preheat" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 2 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <p className="text-gray-700">
                Spread frozen bites in a single layer on a baking sheet or in the air fryer basket.
              </p>
              <img src="https://foodellafoods.com/wp-content/uploads/2023/10/chilli-1.jpg" alt="Arrange" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 3 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <img src="https://i.ytimg.com/vi/VMLMaVV4P78/maxresdefault.jpg" alt="Cook" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 4 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <p className="text-gray-700">
                Serve hot with your favorite cooling dip or as a standalone fiery snack.
              </p>
              <img src="https://foodellafoods.com/wp-content/uploads/2023/10/chhhiii.jpg" alt="Enjoy" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
          </div>
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-8 grid md:grid-cols-2 items-center gap-16">
          <div className="relative order-2 md:order-1 flex justify-center animate-slide-in-left-delay">
            <img
              src="https://i.ytimg.com/vi/MEGTce1Q5ZQ/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLBahwj5rcD2p4R9ATyrQgaaNbyPng" // Example image for bites with dip
              alt="Chilli Garlic Bites with Cooling Yogurt Dip"
          ...
          <div className="text-center md:text-left order-1 md:order-2 animate-slide-in-right-delay">
            <h2 className="text-5xl font-extrabold mb-6">
              Pair with a Creamy Yogurt Dip!
            </h2>
            <p className="text-xl opacity-90 mb-8 max-w-lg mx-auto md:mx-0">
              Balance the fiery kick of your Foodella Chilli Garlic Bites with a simple,
              refreshing **Creamy Yogurt Dip**. It's the perfect cooling contrast!
            </p>
            <ul className="text-lg opacity-90 mb-8 list-disc list-inside space-y-2 max-w-md mx-auto md:mx-0">
              <li>Foodella Chilli Garlic Bites</li>
              <li>Plain Yogurt</li>
              <li>Cucumber (finely diced)</li>
              <li>Fresh Mint & Salt</li>
            </ul>
      ...
      >
        <div className="container mx-auto px-8">
          <h2 className="text-5xl md:text-6xl font-extrabold mb-6 drop-shadow-md">
            Craving That Fiery Crunch?
          </h2>
          <p className="text-2xl md:text-3xl font-light mb-10 max-w-4xl mx-auto">
            Find Foodella Chilli Garlic Bites at a store near you and spice up your day!
          </p>
 ...
 */}
      ...
      <footer className="bg-red-900 text-yellow-100 text-center py-8 text-sm">
        <div className="container mx-auto px-6">
          ...
          <p className="mt-2">Spicy. Garlicky. Unforgettable Bites.</p>
        </div>
      </footer>
    </div>
  );
...
export default ChilliGarlicBitesPage
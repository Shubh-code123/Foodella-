...
import { FaStar, FaRegClock, FaFireAlt, FaShoppingBasket } from 'react-icons/fa'; // FaStar for authentic, FaFireAlt for crispy, FaRegClock for quick
import { IoIosArrowDropleftCircle, IoIosArrowDroprightCircle } from 'react-icons/io';

const AlooTikkiPage = () => {
  const sectionRefs = useRef([]); // For scroll animations
  const productImages = [
    "https://foodellafoods.com/wp-content/uploads/2023/10/Aloo-Tikki-F-247x300.png", // Replace with your Aloo Tikki pack image
    "https://foodellafoods.com/wp-content/uploads/2023/10/aloo.jpg", // Replace with crispy texture close-up
  ];
  ...
  // Sample data for Nutritional Facts (IMPORTANT: Update with actual data for your Aloo Tikki)
  const nutritionalData = [
    { nutrient: "Energy (kcal)", per100g: "160", rda: "8.0" },
    { nutrient: "Protein (g)", per100g: "3.5", rda: "-" },
    { nutrient: "Carbohydrate (g)", per100g: "25.0", rda: "-" },
    { nutrient: "Total Sugars (g)", per100g: "<1.0", rda: "-" },
    { nutrient: "Added Sugars (g)", per100g: "0", rda: "0" },
    { nutrient: "Total Fat (g)", per100g: "5.5", rda: "8.3" },
    { nutrient: "  Saturated Fat (g)", per100g: "Not more than 2.2", rda: "11.0" },
    { nutrient: "  Trans Fat (g)", per100g: "Not more than 0.1", rda: "5" },
    { nutrient: "Sodium (mg)", per100g: "70", rda: "3.5" },
  ];
  ...
  return (
    <div className="font-poppins bg-[#FFF8E1] text-gray-800 leading-relaxed overflow-hidden">
        ...
        <div className="container mx-auto md:pb-20 flex flex-col md:flex-row items-center justify-between relative z-10 text-white gap-12">
          ...
          <div className="text-center md:text-left md:w-1/2 animate-slide-in-left">
            <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-4 drop-shadow-lg">
              Foodella <span className="text-red-900">Aloo Tikki</span>
            </h1>
            <p className="text-xl md:text-2xl font-light max-w-lg mb-8 opacity-90">
              Savor the taste of tradition with Foodella Aloo Tikki! Crispy on the outside,
              soft and flavorful inside. The perfect Indian-inspired potato patty for any time!
            </p>
        ...
        <div className="container mx-auto px-8 relative z-10 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              ...
              <h3 className="text-3xl font-bold mb-4">Authentic Indian Flavor</h3>
              <p className="text-lg opacity-90">
                Crafted with traditional spices and potatoes for a truly authentic taste experience.
              </p>
            </div>
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              <FaFireAlt className="text-6xl text-yellow-400 mb-6 transform group-hover:scale-110 transition-transform" />
              <h3 className="text-3xl font-bold mb-4">Crispy Golden Perfection</h3>
              <p className="text-lg opacity-90">
                Achieve a perfectly golden and delightfully crispy exterior every time you cook them.
              </p>
            </div>
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              <FaRegClock className="text-6xl text-yellow-400 mb-6 transform group-hover:scale-110 transition-transform" />
              <h3 className="text-3xl font-bold mb-4">Versatile & Easy</h3>
              <p className="text-lg opacity-90">
                Ideal as a standalone snack, a delicious side dish, or as part of a meal.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* INLINED: Nutritional Facts Section for Aloo Tikki */}
      <section
      ...
      >
        <div className="container mx-auto px-8">
          <h2 className="text-5xl font-extrabold text-red-600 mb-16">
            Your Path to Perfect Aloo Tikki
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <img src="https://foodellafoods.com/wp-content/uploads/2023/10/Aloo-Tikki-F-247x300.png" alt="Preheat" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 2 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <p className="text-gray-700">
                Place frozen Aloo Tikki in a single layer, ensuring even cooking and crisping.
              </p>
              <img src="https://www.sharmispassions.com/wp-content/uploads/2014/05/aloo-tikki-step9.jpg" alt="Place" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 3 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <p className="text-gray-700">
                Cook until golden brown and crispy, typically 8-12 min in pan/air fryer, or 15-20 min in oven.
              </p>
              <img src="https://foodellafoods.com/wp-content/uploads/2023/10/aloo-tikki-1.jpg" alt="Cook" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 4 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <p className="text-gray-700">
                Serve hot with your favorite chutney, as part of a chaat, or in a burger.
              </p>
              <img src="https://foodellafoods.com/wp-content/uploads/2023/10/aloo.jpg" alt="Enjoy" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
          </div>
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-8 grid md:grid-cols-2 items-center gap-16">
          <div className="relative order-2 md:order-1 flex justify-center animate-slide-in-left-delay">
            <img
              src="https://www.shutterstock.com/image-photo/homemade-indian-vegan-diet-snack-600nw-1894350325.jpg" // Example image for Aloo Tikki Chaat
              alt="Aloo Tikki Chaat Recipe"
          ...
          <div className="text-center md:text-left order-1 md:order-2 animate-slide-in-right-delay">
            <h2 className="text-5xl font-extrabold mb-6">
              Create an Authentic Aloo Tikki Chaat!
            </h2>
            <p className="text-xl opacity-90 mb-8 max-w-lg mx-auto md:mx-0">
              Transform your Foodella Aloo Tikki into a vibrant **Aloo Tikki Chaat**.
              A symphony of flavors and textures in every spoonful!
            </p>
            <ul className="text-lg opacity-90 mb-8 list-disc list-inside space-y-2 max-w-md mx-auto md:mx-0">
              <li>Foodella Aloo Tikki</li>
              <li>Yogurt & Tamarind Chutney</li>
              <li>Chopped Onions & Tomatoes</li>
              <li>Sev & Coriander Garnish</li>
            </ul>
      ...
      >
        <div className="container mx-auto px-8">
          ...
          <p className="text-2xl md:text-3xl font-light mb-10 max-w-4xl mx-auto">
            Find Foodella Aloo Tikki at a store near you and bring the taste of India home!
          </p>
      ...
      <footer className="bg-red-900 text-yellow-100 text-center py-8 text-sm">
        <div className="container mx-auto px-6">
          ...
          <p className="mt-2">Crispy. Flavorful. Authentically Indian.</p>
        </div>
      </footer>
    </div>
  );

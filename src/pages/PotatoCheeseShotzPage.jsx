...
import { FaCheese, FaRegClock, FaFireAlt, FaShoppingBasket, FaStar, FaRegSmileWink } from 'react-icons/fa'; // FaCheese for cheese, FaFireAlt for crispy, FaPartyPopper for fun
import { IoIosArrowDropleftCircle, IoIosArrowDroprightCircle } from 'react-icons/io';

const PotatoCheeseShotzPage = () => {
  const sectionRefs = useRef([]); // For scroll animations
  const productImages = [
    "https://foodellafoods.com/wp-content/uploads/2023/10/Potato-Cheese-Shotz-1-247x300.png", // Replace with your Potato Cheese Shotz pack image
    "https://foodellafoods.com/wp-content/uploads/2023/10/Allo-shotz.jpg", // Replace with cheesy interior close-up
  ];
  ...
  // Sample data for Nutritional Facts (IMPORTANT: Update with actual data for your Potato Cheese Shotz)
  const nutritionalData = [
    { nutrient: "Energy (kcal)", per100g: "190", rda: "9.5" },
    { nutrient: "Protein (g)", per100g: "4.5", rda: "-" },
    { nutrient: "Carbohydrate (g)", per100g: "22.0", rda: "-" },
    { nutrient: "Total Sugars (g)", per100g: "<1.0", rda: "-" },
    { nutrient: "Added Sugars (g)", per100g: "0", rda: "0" },
    { nutrient: "Total Fat (g)", per100g: "9.0", rda: "13.5" },
    { nutrient: "  Saturated Fat (g)", per100g: "Not more than 4.0", rda: "20.0" },
    { nutrient: "  Trans Fat (g)", per100g: "Not more than 0.1", rda: "5" },
    { nutrient: "Sodium (mg)", per100g: "120", rda: "6.0" },
  ];
  ...
  return (
    <div className="font-poppins bg-[#FFF8E1] text-gray-800 leading-relaxed overflow-hidden">
        ...
        <div className="container mx-auto md:pb-20 flex flex-col md:flex-row items-center justify-between relative z-10 text-white gap-12">
          ...
          <div className="text-center md:text-left md:w-1/2 animate-slide-in-left">
            <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-4 drop-shadow-lg">
              Foodella <span className="text-red-900">Potato Cheese</span> Shotz
            </h1>
            <p className="text-xl md:text-2xl font-light max-w-lg mb-8 opacity-90">
              Experience a burst of cheesy delight with Foodella Potato Cheese Shotz!
              Crispy on the outside, with a warm, gooey cheese core. A fun snack for everyone!
            </p>
            <div className="flex justify-center md:justify-start space-x-4 mb-8">
              <span className="text-yellow-300 text-2xl flex items-center"><FaStar /><FaStar /><FaStar /><FaStar /><FaStar /></span>
              <span className="text-yellow-200 text-lg">(4.8/5 stars)</span>
            </div>
          ...
          <div className="relative w-full md:w-2/5 mx-10 flex justify-center items-center h-96 md:h-[600px] animate-scale-in-delay">
            <img
              ...
              alt="Foodella Potato Cheese Shotz Pack"
      ...
      >
        ...
        <div className="container mx-auto px-8 relative z-10 text-center">
          <h2 className="text-5xl font-extrabold mb-16 drop-shadow-md animate-fade-in-up">
            Why Foodella Potato Cheese Shotz?
          </h2>
          <div className="grid md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              <FaCheese className="text-6xl text-yellow-400 mb-6 transform group-hover:scale-110 transition-transform" />
              <h3 className="text-3xl font-bold mb-4">Irresistible Cheese Core</h3>
              <p className="text-lg opacity-90">
                Each shot is filled with a delicious, melting cheese center that bursts with flavor.
              </p>
            </div>
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              <FaFireAlt className="text-6xl text-yellow-400 mb-6 transform group-hover:scale-110 transition-transform" />
              <h3 className="text-3xl font-bold mb-4">Crispy Golden Coating</h3>
              <p className="text-lg opacity-90">
                Cooks up to a perfect golden-brown crisp, providing a satisfying crunch.
              </p>
            </div>
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              <FaRegSmileWink className="text-6xl text-yellow-400 mb-6 transform group-hover:scale-110 transition-transform" />
              <h3 className="text-3xl font-bold mb-4">Fun & Easy Snack</h3>
              <p className="text-lg opacity-90">
                Perfect bite-sized treats for parties, gatherings, or a quick, delightful snack.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* INLINED: Nutritional Facts Section for Potato Cheese Shotz */}
      <section
      ...
      >
        <div className="container mx-auto px-8">
          <h2 className="text-5xl font-extrabold text-red-600 mb-16">
            Your Path to Perfect Potato Cheese Shotz
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <img src="https://foodellafoods.com/wp-content/uploads/2023/10/Potato-Cheese-Shotz-1-247x300.png" alt="Preheat" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 2 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <p className="text-gray-700">
                Spread frozen Shotz in a single layer on a baking sheet or in the air fryer basket.
              </p>
              <img src="https://recipe52.com/wp-content/uploads/2022/04/potato-cheese-balls-12.jpg" alt="Arrange" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 3 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <p className="text-gray-700">
                Cook until golden brown and crispy, with cheese melted inside.
              </p>
              <img src="https://foodellafoods.com/wp-content/uploads/2023/10/Fry-for-3-minutes.jpg" alt="Cook" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 4 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              <div className="text-6xl font-black text-red-400 mb-4">04</div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Serve Hot!</h3>
              <p className="text-gray-700">
                Let cool slightly to avoid burning from melted cheese, then enjoy!
              </p>
              <img src="https://foodellafoods.com/wp-content/uploads/2023/10/Allo-shotz.jpg" alt="Enjoy" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
          </div>
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-8 grid md:grid-cols-2 items-center gap-16">
          <div className="relative order-2 md:order-1 flex justify-center animate-slide-in-left-delay">
            <img
              src="https://i.ytimg.com/vi/xE_DJyACPDg/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLD2wC7QjFzUCPlIOi4VGhWsxfEbxw" // Example image for Shotz platter
              alt="Loaded Cheese Shotz Platter"
          ...
          <div className="text-center md:text-left order-1 md:order-2 animate-slide-in-right-delay">
            <h2 className="text-5xl font-extrabold mb-6">
              Create a Loaded Cheese Shotz Platter!
            </h2>
            <p className="text-xl opacity-90 mb-8 max-w-lg mx-auto md:mx-0">
              Take your Foodella Potato Cheese Shotz to the next level by building a fun and
              delicious **Loaded Cheese Shotz Platter**! Perfect for sharing.
            </p>
            <ul className="text-lg opacity-90 mb-8 list-disc list-inside space-y-2 max-w-md mx-auto md:mx-0">
              <li>Foodella Potato Cheese Shotz</li>
              <li>Salsa, Guacamole, Sour Cream</li>
              <li>Chopped Jalapeños & Spring Onions</li>
              <li>Crumbled Bacon (optional)</li>
            </ul>
      ...
      >
        <div className="container mx-auto px-8">
          <h2 className="text-5xl md:text-6xl font-extrabold mb-6 drop-shadow-md">
            Ready for a Cheesy Explosion?
          </h2>
          <p className="text-2xl md:text-3xl font-light mb-10 max-w-4xl mx-auto">
            Find Foodella Potato Cheese Shotz at a store near you and let the fun begin!
          </p>
      ...
      <footer className="bg-red-900 text-yellow-100 text-center py-8 text-sm">
        <div className="container mx-auto px-6">
          ...
          <p className="mt-2">Cheesy. Crispy. Unforgettable Fun.</p>
        </div>
      </footer>
    </div>
  );
...
export default PotatoCheeseShotzPage;
...
const HerbChilliPattyPage = () => {
  const sectionRefs = useRef([]); // For scroll animations
  const productImages = [
    "https://foodellafoods.com/wp-content/uploads/2023/10/Herb-Chilli-Patty-1-247x300.png", // Replace with your Herb Chilli Patty pack image
    "https://foodellafoods.com/wp-content/uploads/2023/08/HerbChilliPatty_1000x1000-01_1400x_741dea46-871f-442e-b7b4-d48ae44e377e.webp", // Replace with close-up of patty texture
  ];
  ...
  // Sample data for Nutritional Facts (IMPORTANT: Update with actual data for your Herb Chilli Patty)
  const nutritionalData = [
    { nutrient: "Energy (kcal)", per100g: "175", rda: "8.8" },
    { nutrient: "Protein (g)", per100g: "5.2", rda: "-" },
    { nutrient: "Carbohydrate (g)", per100g: "21.5", rda: "-" },
    { nutrient: "Total Sugars (g)", per100g: "1.5", rda: "-" },
    { nutrient: "Added Sugars (g)", per100g: "0", rda: "0" },
    { nutrient: "Total Fat (g)", per100g: "8.0", rda: "12.0" },
    { nutrient: "  Saturated Fat (g)", per100g: "Not more than 2.8", rda: "14.0" },
    { nutrient: "  Trans Fat (g)", per100g: "Not more than 0.1", rda: "5" },
    { nutrient: "Sodium (mg)", per100g: "260", rda: "13.0" }, // Potentially higher due to chili/herbs
    { nutrient: "Dietary Fibre (g)", per100g: "4.2", rda: "-" },
  ];
  ...
  return (
    <div className="font-poppins bg-[#FFF8E1] text-gray-800 leading-relaxed overflow-hidden">
        ...
        <div className="container mx-auto md:pb-20 flex flex-col md:flex-row items-center justify-between relative z-10 text-white gap-12">
          ...
          <div className="text-center md:text-left md:w-1/2 animate-slide-in-left">
            <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-4 drop-shadow-lg">
              Foodella <span className="text-red-900">Herb Chilli</span> Patty
            </h1>
            <p className="text-xl md:text-2xl font-light max-w-lg mb-8 opacity-90">
              Ignite your palate with our exquisitely flavored Herb Chilli Patty.
              Aromatic herbs meet a delightful chilli kick for an unforgettable meal!
            </p>
      ...
      >
        ...
        <div className="container mx-auto px-8 relative z-10 text-center">
          <h2 className="text-5xl font-extrabold mb-16 drop-shadow-md animate-fade-in-up">
            Why Foodella Herb Chilli Patty?
          </h2>
          <div className="grid md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              ...
              <h3 className="text-3xl font-bold mb-4">Aromatic Blend</h3>
              <p className="text-lg opacity-90">
                A rich fusion of fragrant herbs delivers a unique and sophisticated flavor profile.
              </p>
            </div>
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              <FaRegClock className="text-6xl text-yellow-400 mb-6 transform group-hover:scale-110 transition-transform" />
              <h3 className="text-3xl font-bold mb-4">Zesty Kick</h3>
              <p className="text-lg opacity-90">
                Perfectly balanced chili heat that awakens your senses without overpowering the delicious herbal notes.
              </p>
            </div>
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              <FaLeaf className="text-6xl text-yellow-400 mb-6 transform group-hover:scale-110 transition-transform" />
              <h3 className="text-3xl font-bold mb-4">Gourmet Experience</h3>
              <p className="text-lg opacity-90">
                Elevate your meals with a patty that feels homemade and tastes exquisitely gourmet.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* INLINED: Nutritional Facts Section for Herb Chilli Patty */}
      <section
      ...
      >
        <div className="container mx-auto px-8">
          <h2 className="text-5xl font-extrabold text-red-600 mb-16">
            Your Path to a Flavorful Patty
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <img src="https://foodellafoods.com/wp-content/uploads/2023/10/Herb-Chilli-Patty-1-247x300.png    " alt="Preheat" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 2 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <p className="text-gray-700">
                Cook the frozen patty for 7-9 minutes, flipping halfway until golden brown and heated through.
              </p>
              <img src="https://foodellafoods.com/wp-content/uploads/2023/08/frozen-herb-veg-burger-chilli-patty-1000x1000-1.webp" alt="Cook" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 3 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              <div className="text-6xl font-black text-red-400 mb-4">03</div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Serve</h3>
              <p className="text-gray-700">
                Place your cooked patty on a platter, or inside a burger bun or wrap.
              </p>
              <img src="https://shop.bhanufarms.com/wp-content/uploads/2020/03/Product-1.jpg" alt="Serve" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 4 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <p className="text-gray-700">
                Savor the aromatic flavors and chili kick in every delicious bite!
              </p>
              <img src="https://foodellafoods.com/wp-content/uploads/2023/08/HerbChilliPatty_1000x1000-01_1400x_741dea46-871f-442e-b7b4-d48ae44e377e.webp" alt="Enjoy" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
          </div>
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-8 grid md:grid-cols-2 items-center gap-16">
          <div className="relative order-2 md:order-1 flex justify-center animate-slide-in-left-delay">
            <img
              src="https://hyfunfoods.com/wp-content/uploads/2024/05/Kings-Patty-1.png" // Example image for a gourmet wrap
              alt="Gourmet Herb Chilli Patty Wrap"
          ...
          <div className="text-center md:text-left order-1 md:order-2 animate-slide-in-right-delay">
            <h2 className="text-5xl font-extrabold mb-6">
              Elevate with a Zesty Patty Wrap!
            </h2>
            <p className="text-xl opacity-90 mb-8 max-w-lg mx-auto md:mx-0">
              Discover how to create a mouth-watering **Mediterranean Herb Chilli Wrap** using your Foodella patty.
              Fresh, flavorful, and filling!
            </p>
            <ul className="text-lg opacity-90 mb-8 list-disc list-inside space-y-2 max-w-md mx-auto md:mx-0">
              <li>Foodella Herb Chilli Patty</li>
              <li>Whole Wheat Tortillas</li>
              <li>Cucumber & Bell Peppers</li>
              <li>Tahini or Hummus Spread</li>
            </ul>
      ...
      >
        <div className="container mx-auto px-8">
          <h2 className="text-5xl md:text-6xl font-extrabold mb-6 drop-shadow-md">
            Ready for a Burst of Flavor?
          </h2>
          <p className="text-2xl md:text-3xl font-light mb-10 max-w-4xl mx-auto">
            Find Foodella Herb Chilli Patty at a store near you and embark on a culinary adventure!
          </p>
      ...
      <footer className="bg-red-900 text-yellow-100 text-center py-8 text-sm">
        <div className="container mx-auto px-6">
          ...
          <p className="mt-2">Where herbs meet heat, deliciously.</p>
        </div>
      </footer>
    </div>
  );
...
export default HerbChilliPattyPage;
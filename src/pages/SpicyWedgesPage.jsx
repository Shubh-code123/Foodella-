...
const SpicyWedgesPage = () => {
  const sectionRefs = useRef([]); // For scroll animations
  const productImages = [
    "https://foodellafoods.com/wp-content/uploads/2023/10/Spicy-Wedges-247x300.png", // Replace with your Spicy Wedges pack image
    "https://foodellafoods.com/wp-content/uploads/2023/10/veg-.jpg", // Replace with crispy texture close-up
  ];
  ...
  // Sample data for Nutritional Facts (IMPORTANT: Update with actual data for your Spicy Wedges)
  const nutritionalData = [
    { nutrient: "Energy (kcal)", per100g: "135", rda: "6.8" }, // Adjusted slightly for wedges
    { nutrient: "Protein (g)", per100g: "2.8", rda: "-" },
    { nutrient: "Carbohydrate (g)", per100g: "23.0", rda: "-" },
    { nutrient: "Total Sugars (g)", per100g: "<0.5", rda: "-" },
    { nutrient: "Added Sugars (g)", per100g: "0", rda: "0" },
    { nutrient: "Total Fat (g)", per100g: "3.5", rda: "5.3" },
    { nutrient: "  Saturated Fat (g)", per100g: "Not more than 1.5", rda: "7.5" },
    { nutrient: "  Trans Fat (g)", per100g: "Not more than 0.1", rda: "5" },
    { nutrient: "Sodium (mg)", per100g: "55", rda: "2.8" }, // Sodium for spiced wedges
  ];
  ...
  return (
    <div className="font-poppins bg-[#FFF8E1] text-gray-800 leading-relaxed overflow-hidden">
        ...
        <div className="container mx-auto md:pb-20 flex flex-col md:flex-row items-center justify-between relative z-10 text-white gap-12">
          ...
          <div className="text-center md:text-left md:w-1/2 animate-slide-in-left">
            <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-4 drop-shadow-lg">
              Foodella <span className="text-red-900">Spicy</span> Wedges
            </h1>
            <p className="text-xl md:text-2xl font-light max-w-lg mb-8 opacity-90">
              Sink your teeth into our crispy on the outside, fluffy on the inside, perfectly seasoned Spicy Wedges.
              The ideal snack or side for a burst of flavor!
            </p>
          ...
          <div className="relative w-full md:w-2/5 mx-10 flex justify-center items-center h-96 md:h-[600px] animate-scale-in-delay">
            <img
              ...
              alt="Foodella Spicy Wedges Pack"
        ...
        <div className="container mx-auto px-8 relative z-10 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              ...
              <h3 className="text-3xl font-bold mb-4">Crispy & Fluffy</h3>
              <p className="text-lg opacity-90">
                Perfectly cut and seasoned to deliver a delightful crunch outside and soft potato inside.
              </p>
            </div>
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              <FaRegClock className="text-6xl text-yellow-400 mb-6 transform group-hover:scale-110 transition-transform" />
              <h3 className="text-3xl font-bold mb-4">Bold Spicy Flavor</h3>
              <p className="text-lg opacity-90">
                Each wedge is infused with a tantalizing blend of spices for a satisfying kick.
              </p>
            </div>
            <div className="flex flex-col items-center p-8 bg-red-800 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 transition-all duration-300 group">
              <FaLeaf className="text-6xl text-yellow-400 mb-6 transform group-hover:scale-110 transition-transform" />
              <h3 className="text-3xl font-bold mb-4">Versatile Indulgence</h3>
              <p className="text-lg opacity-90">
                Ideal as a standalone snack, a side dish, or as a base for loaded potato creations.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* INLINED: Nutritional Facts Section for Spicy Wedges */}
      <section
      ...
      >
        <div className="container mx-auto px-8">
          <h2 className="text-5xl font-extrabold text-red-600 mb-16">
            Your Path to Perfect Spicy Wedges
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <img src="https://foodellafoods.com/wp-content/uploads/2023/10/Spicy-Wedges-247x300.png" alt="Preheat" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 2 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <img src="https://foodellafoods.com/wp-content/uploads/2023/08/cooking-french-fries-or-fry-potatoes-in-hot-oil-for-potato-wedges-close-up-fried-potatoes-in-oil-on-pan-free-photo.jpg" alt="Arrange" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 3 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              ...
              <p className="text-gray-700">
                Cook until golden brown and crispy, typically 15-20 min in oven, 12-15 in air fryer, or 4-6 min deep fry.
              </p>
              <img src="https://foodellafoods.com/wp-content/uploads/2023/08/cooking-french-fries-or-fry-potatoes-in-hot-oil-for-potato-wedges-close-up-fried-potatoes-in-oil-on-pan-free-photo.jpg" alt="Cook" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
            {/* Step 4 */}
            <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-yellow-500 hover:shadow-xl hover:border-red-500 transition-all duration-300">
              <div className="text-6xl font-black text-red-400 mb-4">04</div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Serve & Savor!</h3>
              <p className="text-gray-700">
                Serve hot with your favorite dip or as a delightful side dish.
              </p>
              <img src="https://foodellafoods.com/wp-content/uploads/2023/10/veg-.jpg" alt="Enjoy" className="mt-6 rounded-lg shadow-md mx-auto w-full object-cover h-32" />
            </div>
          </div>
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-8 grid md:grid-cols-2 items-center gap-16">
          <div className="relative order-2 md:order-1 flex justify-center animate-slide-in-left-delay">
            <img
              src="https://foodellafoods.com/wp-content/uploads/2023/10/veg-.jpg" // Example image for loaded wedges
              alt="Loaded Cheese & Jalapeño Wedges Recipe"
          ...
          <div className="text-center md:text-left order-1 md:order-2 animate-slide-in-right-delay">
            ...
            <p className="text-xl opacity-90 mb-8 max-w-lg mx-auto md:mx-0">
              Transform your Foodella Spicy Wedges into a feast with our **Loaded Cheese & Jalapeño Wedges** recipe.
              Perfect for sharing (or not)!
            </p>
            <ul className="text-lg opacity-90 mb-8 list-disc list-inside space-y-2 max-w-md mx-auto md:mx-0">
              <li>Foodella Spicy Wedges</li>
              <li>Melted Cheese Blend</li>
              <li>Fresh Sliced Jalapeños</li>
              <li>Sour Cream & Chives</li>
            </ul>
      ...
      >
        <div className="container mx-auto px-8">
          <h2 className="text-5xl md:text-6xl font-extrabold mb-6 drop-shadow-md">
            Craving That Spicy Crunch?
          </h2>
          <p className="text-2xl md:text-3xl font-light mb-10 max-w-4xl mx-auto">
            Find Foodella Spicy Wedges at a store near you and elevate your snack game!
          </p>
      ...
      <footer className="bg-red-900 text-yellow-100 text-center py-8 text-sm">
        <div className="container mx-auto px-6">
          ...
          <p className="mt-2">Crispy. Spicy. Deliciously Yours.</p>
        </div>
      </footer>
    </div>
  );
...
export default SpicyWedgesPage;
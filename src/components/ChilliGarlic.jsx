...
const products = [
  {
    name: "Chilli Garlic Bites",
    image:
      "https://foodellafoods.com/wp-content/uploads/2023/10/Chilli-Garlic-Bites-1-247x300.png",
    path: "/Chilli-Garlic-Bites",
  },
];

function ChilliGarlic({ id }) {
  return (
    <section
      id={id}
